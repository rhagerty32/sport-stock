      ...
      <GlassCard style={styles.statsCard}>
          ...
          >
            ...
            <Text
              style={[
                ...
                {
                  color:
                    userPosition.totalGainLoss >= 0 ? Color.green : Color.red,
                },
              ]}
            >
        ...
        <View style={styles.positionMetricsGrid}>
          <View style={styles.positionMetricCard}>
            <Text
              style={[styles.positionMetricLabel, { color: Color.subText }]}
            >
              Current Value
            </Text>
            <Text
              style={[styles.positionMetricValue, { color: Color.baseText }]}
            >
          ...
          <View style={styles.positionMetricCard}>
            ...
            <Text
              style={[styles.positionMetricValue, { color: Color.baseText }]}
            >
              {userPosition.entries.toFixed(4)}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.gainLossContainer}>
          <View style={styles.gainLossHeader}>
            ...
            >
              {userPosition.totalGainLoss >= 0 ? "+" : ""}
              {formatCurrency(userPosition.totalGainLoss)}
            </Text>
          </View>
          ...
          <View style={styles.gainLossBreakdown}>
            <View style={styles.gainLossBreakdownItem}>
              ...
              />
              <Text
                style={[styles.gainLossBreakdownText, { color: Color.subText }]}
              >
                Invested:{" "}
                {formatCurrency(
                  userPosition.currentValue - userPosition.totalGainLoss,
                )}
              </Text>
            </View>
            {userPosition.totalGainLoss !== 0 && (
              <View style={styles.gainLossBreakdownItem}>
                ...
                >
                  {userPosition.totalGainLoss >= 0 ? "Gain" : "Loss"}:{" "}
                  {formatCurrency(Math.abs(userPosition.totalGainLoss))}
                </Text>
              </View>
            )}
          </View>
        ...
        <View style={styles.positionSecondaryMetrics}>
          <View style={styles.positionSecondaryMetric}>
            <Text
              style={[styles.positionSecondaryLabel, { color: Color.subText }]}
            >
              Avg Entry Price
            </Text>
            <Text
              style={[styles.positionSecondaryValue, { color: Color.baseText }]}
            >
